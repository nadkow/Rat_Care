...
private:
    ...
    void loadModel(std::filesystem::path const &path)
    {
        ...
        const aiScene* scene = importer.ReadFile(pathstr, aiProcess_Triangulate | aiProcess_FlipUVs | aiProcess_CalcTangentSpace);
        // check for errors
        ...
        // get the absolute directory path of specified file
